...
Read the [Developer Guidelines](https://github.com/holdex/developers) first.
...
1. Whether you hold to the
   [Code of Conduct](https://github.com/holdex/developers/blob/main/docs/CODE_OF_CONDUCT.md).
1. Whether you follow the
   [Contributing guide](https://github.com/holdex/developers/blob/main/docs/CONTRIBUTING.md).
